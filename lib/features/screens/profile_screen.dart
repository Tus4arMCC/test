...
class _ProfileScreenState extends State<ProfileScreen> with TickerProviderStateMixin {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Stack(
              ...
              children: [
                 Container(
                   ...
                   decoration: BoxDecoration(
                     ...
                     gradient: LinearGradient(
                       colors: [AppColors.primary.withOpacity(0.2), Colors.purple.withOpacity(0.2)],
                     ),
                 ...
                 Container(
                   ...
                   child: Icon(Icons.person_off, size: 40, color: Colors.grey[400]),
                 ),
              ],
            ),
            ...
            Text("Welcome, Guest!", style: textTheme.headlineSmall?.copyWith(fontWeight: FontWeight.w800)),
            ...
            Container(
              ...
              child: Column(
                children: [
                   _buildMenuItem(context, Icons.language, Colors.green, "Language", "English (US)", showArrow: true),
                   const Divider(height: 1, indent: 64),
                   _buildThemeToggleItem(context),
                   const Divider(height: 1, indent: 64),
                   _buildMenuItem(context, Icons.help, Colors.teal, "Help Center", null, showArrow: true),
                   const Divider(height: 1, indent: 64),
                   _buildMenuItem(context, Icons.privacy_tip, Colors.indigo, "Privacy Policy", null, showArrow: true),
                ],
              ),
            ),
            
            const SizedBox(height: 32),
            Text("Version 1.0.2", style: textTheme.bodySmall?.copyWith(color: Colors.grey)),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
              ...
              children: [
                 Container(
                   ...
                   child: CircleAvatar(
                     ...
                     backgroundImage: const NetworkImage("https://lh3.googleusercontent.com/aida-public/AB6AXuB1umkA7zZoXs27SMfZCEJFVYaLstWvfdE79kB6Ojks7mGU7EvZ-zDuy-_IswocfsWHPwNugY8rx0dIX_jNaCY_BrNsBqlB1MTiP92jms22I0ocNp4Jkep6FfaOtDYzI1jau01hdO55Nop2Dxmzg4x7-FyfqGKb-WYR9ZWgqLqHtH5KJoxqGcu58qgJuiesRqq_UoElkNWVilJT8wH2vSCtswp7nhRXHjDClB3ypXCgP7p07IgAyswj-mtPonicyb-1XqkwaAUz_tsx"),
            ...
            Text(email, style: textTheme.bodyMedium?.copyWith(color: Colors.grey)),
            ...
            Container(
              ...
              child: const Row(
                ...
                children: [
                   ...
                   SizedBox(width: 4),
                   Text("VIP FASHIONISTA", style: TextStyle(color: AppColors.primary, fontSize: 11, fontWeight: FontWeight.bold)),
                ],
              ),
            ),
            ...
            // Stats
             ...
             Container(
              ...
              child: Column(
                children: [
                   _buildMenuItem(context, Icons.history, Colors.pink, "Order History", null, showArrow: true, onTap: () => Navigator.pushNamed(context, '/orders')),
                   const Divider(height: 1, indent: 64),
                   _buildMenuItem(context, Icons.place, Colors.blue, "My Addresses", null, showArrow: true, onTap: () => Navigator.pushNamed(context, '/addresses')),
                   const Divider(height: 1, indent: 64),
                   _buildMenuItem(context, Icons.credit_card, Colors.orange, "Payment Methods", null, showArrow: true),
                ],
              ),
            ),
            ...
            const SizedBox(height: 24),
             ...
             Container(
              ...
              child: Column(
                children: [
                   _buildMenuItem(context, Icons.notifications, Colors.purple, "Notifications", null, badgeContent: "2"),
                   const Divider(height: 1, indent: 64),
                   _buildMenuItem(context, Icons.language, Colors.green, "Language", "English (US)", showArrow: true),
                   const Divider(height: 1, indent: 64),
                   _buildThemeToggleItem(context),
  ...
  Widget _buildSectionHeader(BuildContext context, String title, String subtitle) {
     return Row(
       ...
       children: [
         Text(title.toUpperCase(), style: const TextStyle(color: Colors.grey, fontSize: 13, fontWeight: FontWeight.bold, letterSpacing: 0.5)),
  ...
  Widget _buildMenuItem(
    ...
    String title, 
    String? value, 
    {bool showArrow = false, String? badgeContent, VoidCallback? onTap}
  ) {
    return InkWell(
      onTap: onTap,
      child: Padding(
          ...
          children: [
            ...
            if (badgeContent != null)
               Container(
                 ...
                 child: Text(badgeContent, style: const TextStyle(color: Colors.white, fontSize: 10, fontWeight: FontWeight.bold)),
               ),
    ...
    return Padding(
      ...
      child: Row(
        children: [
          ...
          const SizedBox(width: 16),
          const Expanded(child: Text("Dark Mode", style: TextStyle(fontWeight: FontWeight.w600, fontSize: 15))),
